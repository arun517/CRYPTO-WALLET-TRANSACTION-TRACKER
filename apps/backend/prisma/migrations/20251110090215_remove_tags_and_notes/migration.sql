...
INSERT INTO "new_Transaction" ("amount", "blockNumber", "chainId", "createdAt", "fromAddress", "gasPrice", "gasUsed", "hash", "id", "status", "timestamp", "toAddress", "updatedAt", "walletId") SELECT "amount", "blockNumber", "chainId", "createdAt", "fromAddress", "gasPrice", "gasUsed", "hash", "id", "status", "timestamp", "toAddress", "updatedAt", "walletId" FROM "Transaction";
